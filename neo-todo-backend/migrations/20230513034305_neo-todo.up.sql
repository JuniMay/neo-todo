...
CREATE TABLE
    IF NOT EXISTS tbl_duration_task (
...
CREATE TABLE
    IF NOT EXISTS tbl_reminder_task (
        task_id INT UNSIGNED NOT NULL,
...
CREATE TABLE
    IF NOT EXISTS tbl_task_tag (
        task_id INT UNSIGNED NOT NULL,
        tag_id INT UNSIGNED NOT NULL,
        PRIMARY KEY (task_id, tag_id)
    );

ALTER TABLE tbl_duration_task
ADD
    CONSTRAINT fk_duration_task FOREIGN KEY (task_id) REFERENCES tbl_task (task_id);

ALTER TABLE tbl_reminder_task
ADD
